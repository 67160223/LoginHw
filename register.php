<?php
// ==============================
// 🔧 ส่วนตั้งค่า config database
// ==============================
$db_host = "localhost";     // เช่น localhost
$db_user = "s67160223";          // username ฐานข้อมูล
$db_pass = "k4xAcGE4";              // password ฐานข้อมูล
$db_name = "s67160223";   // ชื่อฐานข้อมูลของคุณ
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  // รับค่าจากฟอร์ม (คุณสามารถใส่ค่า default ได้ตามต้องการ)
...
<body>
  <div class="container">
    ...
    <form method="post" action="">
      ...
      <button type="submit">สมัครสมาชิก</button>s
    </form>
  </div>
</body>
</html>
